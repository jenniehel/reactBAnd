...
export default function QrcodeMobile() {
  ...
  return (
    <> 
      <div className={classNames("d-flex  justify-content-between align-items-center qrcodeRecord", styles["mb-0"], styles["border-1"],styles["md-open"])}>
        <div
          className={classNames(" px-3 py-3 border-0 qrcodeProduct", styles["mx-full"], styles["btn-parmary-transparent"])} type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample1">
              ...
              <div className={classNames("itemgroup item1", styles["mb-0"])}>
                ...
                <div className={classNames(styles['border-1-grey'], "mx-0 px-3 py-3", styles.flexBetween)}>
                    ...
                    <div className="time px-2" style={{ textAlign: 'center' }}><small>2024/03/01</small>
                      ...
                      <button type="submit" className={classNames("btn  recordBtn mx-2", styles["btn-parmary"])}>選擇商品 <CgAddR className={classNames(styles["btn-parmary"])} /></button>
